...
import siteLogo from '../public/assets/navLogo.png';
...
const Navbar = () => {
  ...
  return (
    <div style={{backgroundColor: `${navBg}`}} className={shadow ? 'fixed w-full h-20 shadow-xl bg-[#ecf0f3]  z-[100]' : 'fixed w-full h-20 z-[100]'}>
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
        <Link href='/'>
          <a>
            <Image src={siteLogo} alt="/" width='125' height='50'/>
          </a>
        </Link>
        <div>
        ...
        <div className={nav ? 'md:hidden fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ecf0f3] p-10 ease-in duration-500' 
          ...
          <div>
            ...
            <div className='border-b border-gray-300 my-4'>
              <p className='w-[85%] md:2-[90%] py-4'>Let&#39;s build something legendary together</p>
            </div>
            <div className='py-4 flex flex-col'>
              ...
              <div className="pt-40">
                <p className='uppercase tracking-widget text-[#5651e5]'>Let&#39;s Connect </p>
